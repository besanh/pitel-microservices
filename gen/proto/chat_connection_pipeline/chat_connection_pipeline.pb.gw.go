...
func request_ChatConnectionPipelineService_InsertChatConnectionApp_0(ctx context.Context, marshaler runtime.Marshaler, client ChatConnectionPipelineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ChatConnectionPipelineService_InsertChatConnectionApp_0(ctx context.Context, marshaler runtime.Marshaler, server ChatConnectionPipelineServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PostChatConnectionAppRequest
	var metadata runtime.ServerMetadata
...
func RegisterChatConnectionPipelineServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChatConnectionPipelineServiceServer) error {
	...
	mux.Handle("POST", pattern_ChatConnectionPipelineService_InsertChatConnectionApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.chatConnectionPipeline.ChatConnectionPipelineService/InsertChatConnectionApp", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-connection-pipeline/app"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ChatConnectionPipelineService_InsertChatConnectionApp_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ChatConnectionPipelineService_InsertChatConnectionApp_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ChatConnectionPipelineService_AttachConnectionQueueToApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.chatConnectionPipeline.ChatConnectionPipelineService/AttachConnectionQueueToApp", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-connection-pipeline/queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterChatConnectionPipelineServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatConnectionPipelineServiceClient) error {
	...
	mux.Handle("POST", pattern_ChatConnectionPipelineService_InsertChatConnectionApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.chatConnectionPipeline.ChatConnectionPipelineService/InsertChatConnectionApp", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-connection-pipeline/app"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ChatConnectionPipelineService_InsertChatConnectionApp_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ChatConnectionPipelineService_AttachConnectionQueueToApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.chatConnectionPipeline.ChatConnectionPipelineService/AttachConnectionQueueToApp", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-connection-pipeline/queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ChatConnectionPipelineService_InsertChatConnectionApp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss-chat", "v1", "chat-connection-pipeline", "app"}, ""))

	pattern_ChatConnectionPipelineService_AttachConnectionQueueToApp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss-chat", "v1", "chat-connection-pipeline", "queue"}, ""))
)

var (
	forward_ChatConnectionPipelineService_InsertChatConnectionApp_0 = runtime.ForwardResponseMessage
