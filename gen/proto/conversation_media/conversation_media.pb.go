...
type ConversationMedia struct {
	...
	MediaSize              string                 `protobuf:"bytes,12,opt,name=media_size,json=mediaSize,proto3" json:"media_size,omitempty"`
...
func (x *ConversationMedia) GetMediaSize() string {
	if x != nil {
		return x.MediaSize
	}
	return ""
...
var file_proto_conversation_media_conversation_media_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x09, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x41, 0x0a, 0x0e,
