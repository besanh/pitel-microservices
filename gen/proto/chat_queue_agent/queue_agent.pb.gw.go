...
func RegisterQueueAgentServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QueueAgentServiceServer) error {
	...
	mux.Handle("POST", pattern_QueueAgentService_InsertQueueAgent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.chat_queue_agent.QueueAgentService/InsertQueueAgent", runtime.WithHTTPPathPattern("/bss/v1/chat/queue-agent"))
		if err != nil {
...
func RegisterQueueAgentServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QueueAgentServiceClient) error {
	...
	mux.Handle("POST", pattern_QueueAgentService_InsertQueueAgent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.chat_queue_agent.QueueAgentService/InsertQueueAgent", runtime.WithHTTPPathPattern("/bss/v1/chat/queue-agent"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_QueueAgentService_InsertQueueAgent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss", "v1", "chat", "queue-agent"}, ""))
)
