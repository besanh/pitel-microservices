...
func request_IncomService_HandleWebhook_0(ctx context.Context, marshaler runtime.Marshaler, client IncomServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_IncomService_HandleWebhook_0(ctx context.Context, marshaler runtime.Marshaler, server IncomServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IncomBodyRequest
	var metadata runtime.ServerMetadata
...
func RegisterIncomServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IncomServiceServer) error {
	...
	mux.Handle("POST", pattern_IncomService_HandleWebhook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.inbox_marketing_incom.IncomService/HandleWebhook", runtime.WithHTTPPathPattern("/bss/v1/incom/webhook/{plugin_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_IncomService_HandleWebhook_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_IncomService_HandleWebhook_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIncomServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IncomServiceClient) error {
	...
	mux.Handle("POST", pattern_IncomService_HandleWebhook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.inbox_marketing_incom.IncomService/HandleWebhook", runtime.WithHTTPPathPattern("/bss/v1/incom/webhook/{plugin_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_IncomService_HandleWebhook_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_IncomService_HandleWebhook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"bss", "v1", "incom", "webhook", "plugin_id"}, ""))
)

var (
	forward_IncomService_HandleWebhook_0 = runtime.ForwardResponseMessage
)
