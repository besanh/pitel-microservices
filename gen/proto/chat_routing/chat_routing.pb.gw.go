...
func RegisterChatRoutingHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChatRoutingServer) error {
	...
	mux.Handle("POST", pattern_ChatRouting_PostChatRouting_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.chat_routing.ChatRouting/PostChatRouting", runtime.WithHTTPPathPattern("/bss/v1/chat/chat-routing"))
		if err != nil {
...
func RegisterChatRoutingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatRoutingClient) error {
	...
	mux.Handle("POST", pattern_ChatRouting_PostChatRouting_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.chat_routing.ChatRouting/PostChatRouting", runtime.WithHTTPPathPattern("/bss/v1/chat/chat-routing"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ChatRouting_PostChatRouting_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss", "v1", "chat", "chat-routing"}, ""))
)
