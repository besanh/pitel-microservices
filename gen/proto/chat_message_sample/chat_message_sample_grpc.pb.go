...
const (
	MessageSampleService_GetChatMessageSamples_FullMethodName   = "/proto.chatMessageSample.MessageSampleService/GetChatMessageSamples"
	MessageSampleService_GetMessageSampleById_FullMethodName    = "/proto.chatMessageSample.MessageSampleService/GetMessageSampleById"
	MessageSampleService_InsertMessageSample_FullMethodName     = "/proto.chatMessageSample.MessageSampleService/InsertMessageSample"
	MessageSampleService_UpdateMessageSampleById_FullMethodName = "/proto.chatMessageSample.MessageSampleService/UpdateMessageSampleById"
	MessageSampleService_DeleteMessageSampleById_FullMethodName = "/proto.chatMessageSample.MessageSampleService/DeleteMessageSampleById"
)
...
func (c *messageSampleServiceClient) GetChatMessageSamples(ctx context.Context, in *GetChatMessageSamplesRequest, opts ...grpc.CallOption) (*GetChatMessageSamplesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageSampleService_GetChatMessageSamples_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageSampleServiceClient) GetMessageSampleById(ctx context.Context, in *GetMessageSampleByIdRequest, opts ...grpc.CallOption) (*GetMessageSampleByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageSampleService_GetMessageSampleById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageSampleServiceClient) InsertMessageSample(ctx context.Context, in *PostMessageSampleRequest, opts ...grpc.CallOption) (*PostMessageSampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageSampleService_InsertMessageSample_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageSampleServiceClient) UpdateMessageSampleById(ctx context.Context, in *PutMessageSampleRequest, opts ...grpc.CallOption) (*PutMessageSampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageSampleService_UpdateMessageSampleById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageSampleServiceClient) DeleteMessageSampleById(ctx context.Context, in *DeleteMessageSampleRequest, opts ...grpc.CallOption) (*DeleteMessageSampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageSampleService_DeleteMessageSampleById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessageSampleService_GetChatMessageSamples_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageSampleService_GetChatMessageSamples_FullMethodName,
	}
...
func _MessageSampleService_GetMessageSampleById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageSampleService_GetMessageSampleById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessageSampleService_InsertMessageSample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageSampleService_InsertMessageSample_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessageSampleService_UpdateMessageSampleById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageSampleService_UpdateMessageSampleById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessageSampleService_DeleteMessageSampleById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageSampleService_DeleteMessageSampleById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
