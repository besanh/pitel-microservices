...
type Message struct {
	...
	SendTimestamp       int32                  `protobuf:"varint,19,opt,name=send_timestamp,json=sendTimestamp,proto3" json:"send_timestamp,omitempty"`
	...
	ReadTimestamp       int32                  `protobuf:"varint,23,opt,name=read_timestamp,json=readTimestamp,proto3" json:"read_timestamp,omitempty"`
...
func (x *Message) GetReadTimestamp() int32 {
	if x != nil {
...
var file_proto_message_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x0d, 0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	...
	0x18, 0x17, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x72, 0x65, 0x61, 0x64, 0x54, 0x69, 0x6d, 0x65,
