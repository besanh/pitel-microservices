...
const (
	MessageService_GetMessagesWithScrollAPI_FullMethodName = "/proto.message.MessageService/GetMessagesWithScrollAPI"
	MessageService_GetMessages_FullMethodName              = "/proto.message.MessageService/GetMessages"
	MessageService_SendMessage_FullMethodName              = "/proto.message.MessageService/SendMessage"
	MessageService_MarkReadMessages_FullMethodName         = "/proto.message.MessageService/MarkReadMessages"
	MessageService_ShareInfo_FullMethodName                = "/proto.message.MessageService/ShareInfo"
)
...
func (c *messageServiceClient) GetMessagesWithScrollAPI(ctx context.Context, in *GetMessagesScrollRequest, opts ...grpc.CallOption) (*GetMessagesScrollResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageService_GetMessagesWithScrollAPI_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageServiceClient) MarkReadMessages(ctx context.Context, in *MarkReadMessagesRequest, opts ...grpc.CallOption) (*MarkReadMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageService_MarkReadMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageServiceClient) ShareInfo(ctx context.Context, in *ShareInfoRequest, opts ...grpc.CallOption) (*ShareInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessageService_ShareInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessageService_GetMessagesWithScrollAPI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_GetMessagesWithScrollAPI_FullMethodName,
	}
...
func _MessageService_MarkReadMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_MarkReadMessages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessageService_ShareInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_ShareInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
