...
const (
	AssignConversationService_GetUserAssigned_FullMethodName   = "/proto.assignConversation.AssignConversationService/GetUserAssigned"
	AssignConversationService_GetUserInQueue_FullMethodName    = "/proto.assignConversation.AssignConversationService/GetUserInQueue"
	AssignConversationService_InsertUserInQueue_FullMethodName = "/proto.assignConversation.AssignConversationService/InsertUserInQueue"
)
...
func (c *assignConversationServiceClient) GetUserAssigned(ctx context.Context, in *GetUserAssignedRequest, opts ...grpc.CallOption) (*GetUserAssignedResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssignConversationService_GetUserAssigned_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assignConversationServiceClient) GetUserInQueue(ctx context.Context, in *GetUserInQueueRequest, opts ...grpc.CallOption) (*GetUserInQueueResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssignConversationService_GetUserInQueue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assignConversationServiceClient) InsertUserInQueue(ctx context.Context, in *PostUserInQueueRequest, opts ...grpc.CallOption) (*PostUserInQueueResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssignConversationService_InsertUserInQueue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssignConversationService_GetUserAssigned_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssignConversationService_GetUserAssigned_FullMethodName,
	}
...
func _AssignConversationService_GetUserInQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssignConversationService_GetUserInQueue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
