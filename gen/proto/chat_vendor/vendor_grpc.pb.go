...
func (c *chatVendorServiceClient) PostChatVendor(ctx context.Context, in *PostChatVendorRequest, opts ...grpc.CallOption) (*PostChatVendorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.chatVendor.ChatVendorService/PostChatVendor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatVendorServiceClient) GetChatVendors(ctx context.Context, in *GetChatVendorsRequest, opts ...grpc.CallOption) (*GetChatVendorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.chatVendor.ChatVendorService/GetChatVendors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatVendorServiceClient) GetChatVendorById(ctx context.Context, in *GetChatVendorRequest, opts ...grpc.CallOption) (*GetChatVendorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.chatVendor.ChatVendorService/GetChatVendorById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatVendorServiceClient) UpdateChatVendorById(ctx context.Context, in *UpdateChatVendorRequest, opts ...grpc.CallOption) (*UpdateChatVendorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.chatVendor.ChatVendorService/UpdateChatVendorById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatVendorServiceClient) DeleteChatVendorById(ctx context.Context, in *DeleteChatVendorRequest, opts ...grpc.CallOption) (*DeleteChatVendorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.chatVendor.ChatVendorService/DeleteChatVendorById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatVendorService_PostChatVendor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.chatVendor.ChatVendorService/PostChatVendor",
	}
...
func _ChatVendorService_GetChatVendors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.chatVendor.ChatVendorService/GetChatVendors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatVendorService_GetChatVendorById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.chatVendor.ChatVendorService/GetChatVendorById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatVendorService_UpdateChatVendorById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.chatVendor.ChatVendorService/UpdateChatVendorById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatVendorService_DeleteChatVendorById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.chatVendor.ChatVendorService/DeleteChatVendorById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
