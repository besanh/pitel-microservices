...
const (
	ChatConnectionQueueService_GetChatConnectionQueueById_FullMethodName = "/proto.chatConnectionQueue.ChatConnectionQueueService/GetChatConnectionQueueById"
)
...
func (c *chatConnectionQueueServiceClient) GetChatConnectionQueueById(ctx context.Context, in *GetChatConnectionQueueByIdRequest, opts ...grpc.CallOption) (*GetChatConnectionQueueByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatConnectionQueueService_GetChatConnectionQueueById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatConnectionQueueService_GetChatConnectionQueueById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatConnectionQueueService_GetChatConnectionQueueById_FullMethodName,
	}
