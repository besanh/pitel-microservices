...
const (
	ChatQueueUserService_InsertChatQueueUser_FullMethodName     = "/proto.chatQueueUser.ChatQueueUserService/InsertChatQueueUser"
	ChatQueueUserService_UpdateChatQueueUserById_FullMethodName = "/proto.chatQueueUser.ChatQueueUserService/UpdateChatQueueUserById"
)
...
func (c *chatQueueUserServiceClient) InsertChatQueueUser(ctx context.Context, in *PostChatQueueUserRequest, opts ...grpc.CallOption) (*PostChatQueueUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatQueueUserService_InsertChatQueueUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatQueueUserServiceClient) UpdateChatQueueUserById(ctx context.Context, in *PutChatQueueUserRequest, opts ...grpc.CallOption) (*PutChatQueueUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatQueueUserService_UpdateChatQueueUserById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatQueueUserService_InsertChatQueueUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatQueueUserService_InsertChatQueueUser_FullMethodName,
	}
...
func _ChatQueueUserService_UpdateChatQueueUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatQueueUserService_UpdateChatQueueUserById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
