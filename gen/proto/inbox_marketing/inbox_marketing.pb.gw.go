...
func request_InboxMarketingService_SendInboxMarketing_0(ctx context.Context, marshaler runtime.Marshaler, client InboxMarketingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InboxMarketingBodyRequest
...
var (
	filter_InboxMarketingService_ReportInboxMarketing_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_InboxMarketingService_ReportInboxMarketing_0(ctx context.Context, marshaler runtime.Marshaler, client InboxMarketingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InboxMarketingRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_InboxMarketingService_ReportInboxMarketing_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ReportInboxMarketing(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_InboxMarketingService_ReportInboxMarketing_0(ctx context.Context, marshaler runtime.Marshaler, server InboxMarketingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InboxMarketingRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ReportInboxMarketing(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterInboxMarketingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InboxMarketingServiceServer) error {
	...
	mux.Handle("GET", pattern_InboxMarketingService_ReportInboxMarketing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.inbox_marketing.InboxMarketingService/ReportInboxMarketing", runtime.WithHTTPPathPattern("/bss/v1/inbox-marketing/report"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_InboxMarketingService_ReportInboxMarketing_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_InboxMarketingService_ReportInboxMarketing_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterInboxMarketingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InboxMarketingServiceClient) error {
	...
	mux.Handle("GET", pattern_InboxMarketingService_ReportInboxMarketing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.inbox_marketing.InboxMarketingService/ReportInboxMarketing", runtime.WithHTTPPathPattern("/bss/v1/inbox-marketing/report"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_InboxMarketingService_ReportInboxMarketing_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_InboxMarketingService_ReportInboxMarketing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss", "v1", "inbox-marketing", "report"}, ""))
)

var (
	forward_InboxMarketingService_SendInboxMarketing_0 = runtime.ForwardResponseMessage

	forward_InboxMarketingService_ReportInboxMarketing_0 = runtime.ForwardResponseMessage
)
