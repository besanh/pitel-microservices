...
func request_ChatAppService_GetChatAppAssign_0(ctx context.Context, marshaler runtime.Marshaler, client ChatAppServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetChatAppAssignRequest
	var metadata runtime.ServerMetadata

	msg, err := client.GetChatAppAssign(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ChatAppService_GetChatAppAssign_0(ctx context.Context, marshaler runtime.Marshaler, server ChatAppServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetChatAppAssignRequest
	var metadata runtime.ServerMetadata

	msg, err := server.GetChatAppAssign(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterChatAppServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChatAppServiceServer) error {
	...
	mux.Handle("GET", pattern_ChatAppService_GetChatAppAssign_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.chatApp.ChatAppService/GetChatAppAssign", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-app/assign"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ChatAppService_GetChatAppAssign_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ChatAppService_GetChatAppAssign_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChatAppServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatAppServiceClient) error {
	...
	mux.Handle("GET", pattern_ChatAppService_GetChatAppAssign_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.chatApp.ChatAppService/GetChatAppAssign", runtime.WithHTTPPathPattern("/bss-chat/v1/chat-app/assign"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ChatAppService_GetChatAppAssign_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ChatAppService_GetChatAppAssign_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bss-chat", "v1", "chat-app", "assign"}, ""))
)
...
var (
	...
	forward_ChatAppService_GetChatAppAssign_0 = runtime.ForwardResponseMessage
)
