...
func (r *RedisClient) Set(key string, value any) (string, error) {
	ret, err := r.Client.Set(ctx, key, value, 0).Result()
	return ret, err
}

// Set - Set a value with key to Redis DB
func (r *RedisClient) SetTTL(key string, value any, t time.Duration) (string, error) {
...
func (r *RedisClient) HMSet(key string, values ...any) error {
...
func (r *RedisClient) FLUSHALL() any {
	ret := r.Client.FlushAll(ctx)
	return ret
}

func (r *RedisClient) HMGet(key string, fields ...string) ([]any, error) {
