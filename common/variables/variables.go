...
var (
	...
	MAP_ERROR_CODE = map[constants.ERROR_CODE]string{
		constants.ERR_UNAUTHORIZED:              "unauthorized",
		constants.ERR_FORBIDDEN:                 "forbidden",
		constants.ERR_SERVICE_UNAVAILABLE:       "service unavailable",
		constants.ERR_INTERNAL_SERVER_ERROR:     "internal server error",
		constants.ERR_NOT_IMPLEMENTED:           "not implemented",
		constants.ERR_NOT_IMPLEMENT_FOR_MASTER:  "not implemented for master",
		constants.ERR_USERNAME_NOT_FOUND:        "username not found",
		constants.ERR_USERNAME_EXISTS:           "username exists",
		constants.ERR_USER_NOTFOUND:             "user not found",
		constants.ERR_EMAIL_NOTFOUND:            "email not found",
		constants.ERR_TOKEN_IS_EMPTY:            "token is empty",
		constants.ERR_TOKEN_IS_INVALID:          "token is invalid",
		constants.ERR_TOKEN_IS_EXPIRED:          "token is expired",
		constants.ERR_REFRESH_TOKEN_INVALID:     "refresh token invalid",
		constants.ERR_INVALID_USERNAME_PASSWORD: "username or password invalid",
		constants.ERR_MISSING_USER_ID:           "missing user id",
		constants.ERR_CURRENT_PASSWORD_INVALID:  "current password invalid",
		constants.ERR_PASSWORD_INVALID:          "password invalid",
		constants.ERR_USERNAME_IS_EXISTED:       "username is existed",
		constants.ERR_USER_CODE_IS_EXISTED:      "user code is existed",
		constants.ERR_USER_CODE_IS_INVALID:      "user code is invalid",
		constants.ERR_GROUP_CODE_IS_EXISTED:     "group code is existed",
		constants.ERR_ROLE_NOTFOUND:             "role not found",
		constants.ERR_BUSINESS_UNIT_NOTFOUND:    "business unit not found",
		constants.ERR_GROUP_NOTFOUND:            "group not found",
		constants.ERR_PARENT_GROUP_NOTFOUND:     "parent group not found",
		constants.ERR_SERVICE_NOTFOUND:          "service not found",
		constants.ERR_USER_SERVICE_NOTFOUND:     "user service not found",
		constants.ERR_TENANT_NOTFOUND:           "tenant not found",
		constants.ERR_FEATURE_NOTFOUND:          "feature not found",
		constants.ERR_FEATURE_EXIST:             "feature already exist",
		constants.ERR_PARAMETER_NOTFOUND:        "parameter not found",
		constants.ERR_PARAMETER_EXIST:           "parameter already exist",
		constants.ERR_REQUEST_INVALID:           "request invalid",
		constants.ERR_REQUEST_IS_EXISTED:        "request is existed",
		constants.ERR_REQUEST_NOTFOUND:          "request not found",
		constants.ERR_REQUEST_IS_EXPIRED:        "request is expired",
		constants.ERR_REQUEST_CODE_IS_INVALID:   "request code is invalid",
	}
)

func NewError(code constants.ERROR_CODE) constants.ERROR_MSG {
