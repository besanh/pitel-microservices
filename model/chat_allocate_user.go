...
type AllocateUser struct {
	*Base
	bun.BaseModel          `bun:"table:chat_allocate_user,alias:cau"`
	...
	ConversationId         string `json:"conversation_id" bun:"conversation_id,type:uuid,notnull"`
