...
// func (s *OttMessage) CheckChatSetting(ctx context.Context, message model.Message, userChan chan<- model.User, chatApp model.ChatApp) (err error) {
...
// 	userAllocateCache := cache.RCache.Get(GenerateConversationId(message.AppId, message.OaId, message.ExternalUserId))
// 	if userAllocateCache != nil {
// 		if err := json.Unmarshal([]byte(userAllocateCache.(string)), userAllocate); err != nil {
// 			log.Error(err)
// 			return err
// 		}
// 	} else {
...
// 			return err
// 		}
// 		userAllocate = &(*userAllocations)[0]
// 		if err := cache.RCache.Set(USER_ALLOCATE+"_"+GenerateConversationId(message.AppId, message.OaId, message.ExternalUserId), userAllocate, USER_ALLOCATE_EXPIRE); err != nil {
// 			log.Error(err)
// 			return err
// 		}
// 	}
...
// 	if userAllocate != nil {
// 		if userAllocate.MainAllocate == "deactive" {
// 			authInfo.TenantId = userAllocate.TenantId
// 			authInfo.UserId = userAllocate.UserId
// 			user.AuthUser = &authInfo
// 			user.ConnectionId = userAllocate.ConnectionId
...
// 	var authInfo model.AuthUser
// 	// var integrateSystem model.ChatIntegrateSystem
// 	// find is from chat
// 	// filterChatAppIntegrateSystem := model.ChatAppIntegrateSystemFilter{
// 	// 	ChatAppId: chatApp.Id,
// 	// }
// 	// _, chatAppIntegrateSystem, err := repository.ChatAppIntegrateSystemRepo.GetChatAppIntegrateSystems(ctx, repository.DBConn, filterChatAppIntegrateSystem, -1, 0)
// 	// if err != nil {
// 	// 	log.Error(err)
// 	// 	return
// 	// }
// 	// if len(*chatAppIntegrateSystem) > 0 {
// 	// 	integrateSystem = (*chatAppIntegrateSystem)[0]
// 	// }
