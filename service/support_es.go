...
func InsertMessage(ctx context.Context, tenantId, index, appId, docId string, data any) error {
	...
	err = repository.ESRepo.InsertLog(ctx, tenantId, ES_INDEX_MESSAGE, appId, docId, esDoc)
	if err != nil {
		log.Error(err)
		return err
	}
