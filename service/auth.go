...
func (auth *Auth) Login(ctx context.Context, body model.LoginRequest) (result *model.LoginResponse, err error) {
	user, err := repository.BssUserRepo.GetUserByUsername(ctx, body.Username)
	if err != nil {
		log.Error(err)
		return nil, err
	} else if user == nil {
...
// 		return nil, variables.NewError(constants.ERR_REFRESH_TOKEN_INVALID)
// 	}
...
// 	user, err := repository.AAA_UserRepo.FindByQuery(ctx, sql_builder.EqualQuery("email", body.Email))
// 	if err != nil {
// 		log.Error(err)
// 		return
// 	} else if user == nil {
...
// 	aaaRequest, err := repository.AAA_RequestRepo.FindByQuery(ctx, sql_builder.EqualQuery("user_id", user.Id))
// 	if err != nil {
// 		log.Error(err)
// 		return
...
// 	if err = repository.AAA_RequestRepo.Insert(ctx, *aaaRequest); err != nil {
// 		log.Error(err)
// 		return
// 	}
...
// 	aaaRequest, err := repository.AAA_RequestRepo.FindByQuery(ctx, sql_builder.EqualQuery("token", body.Token))
// 	if err != nil {
// 		log.Error(err)
// 		return
// 	} else if aaaRequest == nil {
...
// 	}
// 	aaaRequest, err := repository.AAA_RequestRepo.FindByQuery(ctx, conditions...)
// 	if err != nil {
// 		log.Error(err)
// 		return
// 	} else if aaaRequest == nil {
...
// 		if err = repository.AAA_RequestRepo.Update(ctx, *aaaRequest); err != nil {
// 			log.Error(err)
// 		}
...
// 	user, err := repository.AAA_UserRepo.FindById(ctx, aaaRequest.UserId)
// 	if err != nil {
// 		log.Error(err)
// 		return
// 	} else if user == nil {
...
// 	if err = repository.AAA_UserRepo.Update(ctx, *user); err != nil {
// 		log.Error(err)
// 		return
// 	}
...
// 	user, err := repository.AAA_UserRepo.FindInfoById(ctx, goAuthUser.UserId, model.AAA_UserQueryParam{})
// 	if err != nil {
// 		log.ErrorContext(ctx, err)
// 		return err
// 	} else if user == nil {
